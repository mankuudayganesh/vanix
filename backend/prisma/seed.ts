...
async function main() {
  ...
  const passwordHash = await bcrypt.hash('vanix@admin2024', 12);
  ...
  const categories = [
    { name: 'Trending Now', slug: 'trending-now', type: 'SPECIAL' as const, displayOrder: 1 },
    { name: 'Top 10 India', slug: 'top-10-india', type: 'SPECIAL' as const, displayOrder: 2 },
    { name: 'Top 10 Global', slug: 'top-10-global', type: 'SPECIAL' as const, displayOrder: 3 },
    { name: 'Recently Added', slug: 'recently-added', type: 'SPECIAL' as const, displayOrder: 4 },
    { name: 'VANIX Originals', slug: 'vanix-originals', type: 'COLLECTION' as const, displayOrder: 5 },
    { name: 'Anime Collection', slug: 'anime-collection', type: 'COLLECTION' as const, displayOrder: 6 },
    { name: 'Sports Collection', slug: 'sports-collection', type: 'COLLECTION' as const, displayOrder: 7 },
    { name: 'Kids Collection', slug: 'kids-collection', type: 'COLLECTION' as const, displayOrder: 8 },
    { name: 'Coming Soon', slug: 'coming-soon', type: 'SPECIAL' as const, displayOrder: 9 },
  ];
